        ...
        <div className="relative aspect-square overflow-hidden bg-brand-beige group">
          ...
          <div className="absolute inset-x-3 bottom-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex gap-2">
            <button
              ...
              className="flex-1 bg-white/90 hover:bg-white text-brand-darkGreen text-xs font-semibold py-2 rounded-button backdrop-blur-sm flex items-center justify-center gap-1 shadow-soft"
            >
              <Eye className="w-3.5 h-3.5" /> Quick View
            </button>
            <button
              onClick={() => setShowBrewingGuide(true)}
              className="bg-brand-darkGreen hover:bg-black text-brand-gold text-xs font-semibold px-3 py-2 rounded-button flex items-center justify-center"
        ...
        <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
          ...
          <div className="pt-2 border-t border-brand-mint/20 flex items-center justify-between">
            ...
            <button
              ...
              className="bg-brand-green hover:bg-brand-darkGreen text-white text-xs font-semibold px-3.5 py-2 rounded-button shadow-soft flex items-center gap-1.5 transition-all duration-200 hover:scale-105"
            >
